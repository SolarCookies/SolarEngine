...
public:
	LightComponent()
		: lightMesh("Assets/Models/sun.obj", "light"), // Provide valid constructor args
		SunTexture("Assets/Models/sun.png", GL_TEXTURE_2D, GL_TEXTURE0, GL_RGBA, GL_UNSIGNED_BYTE)
	{
		name = "LightComponent";
	}
	...
	void RenderDetails() override {
		...
		ImGui::InputFloat("Light Intensity", &lightIntensity, 1.0f, 10.0f, "%.2f");
	}
